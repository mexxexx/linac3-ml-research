...
Now, the important this to understand here, is that this integral can be very difficult to calculate and can be typically only been simulated numerically. But, if one chooses
