...
\begin{figure}
	...
	\caption{The BOCPD Algorithm applied to a few hours from November 2018 without removing voltage breakdowns, sampled at ten seconds. Here, the run length posterior is color coded differently to show some nuances. Yellow indicates a lower probability while purple indicates a higher run length probability.}
